...
{
    //this animal type
    [SerializeField] private AnimalTypes animalType = AnimalTypes.Rabbit;
    ...
    private void Awake()
    {
        ...
        //range this animal can interact with objects
        attackRange = 0.5f;
        //food objects dropped when this animal is killed
        foodValue = 1;

        //attributes scales
        BASEATTRIBUTESAMOUNT = 20;
        BASEATTRIBUTESRANGE = 10;
        MAXBASEATTRIBUTEAMOUNT = 35;
    ...
    void Update()
    {
        ...
        {
            hungerTimer = 0;
            hungerTime = Random.Range(0.6f, 0.8f);
        ...
        else
        {
            ...
            lookForAttackersWaitTime = Random.Range(0.05f, 0.15f);
        ...
        if (HUNGER <= simulationManager.vitals.HungerStats().satisfiedValue)
        {
            ...
            else
            {
                ...
                LookForFood(Food.FoodTypes.Vegetarian);
            }
        }
